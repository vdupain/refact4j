 ...
 * AbstractArithmeticUnaryOperator interface, to minimize the effort required to
 ...
 * @param <T>
 */
abstract class AbstractArithmeticUnaryOperator<T extends Number> implements ArithmeticUnaryOperator<T> {
