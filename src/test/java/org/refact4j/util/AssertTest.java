...
import static org.refact4j.util.Assert.and;
import static org.refact4j.util.Assert.assertThat;
import static org.refact4j.util.Assert.between;
import static org.refact4j.util.Assert.equalTo;
import static org.refact4j.util.Assert.instanceOf;
import static org.refact4j.util.Assert.isNotNull;
import static org.refact4j.util.Assert.isNull;
import static org.refact4j.util.Assert.matchRegEx;
import static org.refact4j.util.Assert.not;
import static org.refact4j.util.Assert.notEqualTo;
import static org.refact4j.util.Assert.or;
