...
public class EntityUtilsTest {
    ...
    public void testApplyEmptyDefaultValues() {
        ...
        List<EntityObject> dataEntities = EntityXmlReaderHelper.parse(builder.get(), dataXml);
        ...
        String expected = "<entities>" +
                ...
                "</entities>";
        List<EntityObject> expectedEntities = EntityXmlReaderHelper.parse(builder.get(), expected);
